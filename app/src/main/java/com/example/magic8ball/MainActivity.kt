...
class MainActivity : AppCompatActivity() {
    ...
    private fun shakeBall() {
        val magicBallImageView: ImageView = findViewById(R.id.magicBallImageView)
        val randomChoice = Random.nextInt(21)
        ...
        magicBallImageView.setImageResource(imageResource)
    }
}